...
namespace SplineMesh {
    ...
    public class SplineMeshTiling : MonoBehaviour {
        ...
        private void OnDisable()
        {
            ...
            for(int i = 0; i < generated.transform.childCount; i++)
            {
                if(Application.isPlaying)
                {
                    Destroy(generated.transform.GetChild(i).gameObject);
                }
                else
                {
                    DestroyImmediate(generated.transform.GetChild(i).gameObject);
                }                
            }
        }*/
