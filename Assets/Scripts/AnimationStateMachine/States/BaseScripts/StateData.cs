...
public abstract class StateData : ScriptableObject
{
    ...
    public abstract void OnTransitionEnter(CharacterState characterState, Animator animator);
    public abstract void OnTransitionExit(CharacterState characterState, Animator animator);
}
