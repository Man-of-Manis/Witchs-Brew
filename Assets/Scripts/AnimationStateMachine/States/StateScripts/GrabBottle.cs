...
[CreateAssetMenu(fileName = "New State", menuName = "Unnamed Wizard Game/AbilityData/GrabBottle")]
public class GrabBottle : StateData
{
    float timer = 0;
    bool firstTime = true;
    ...
    public override void UpdateAbility(CharacterState characterState, Animator animator, AnimatorStateInfo stateInfo)
    {
        ...
        if (timer >= 0.5f && firstTime)
        {
            characterState.GetPlayerHealth(animator).BottlePosition(1);
            firstTime = false;
        }
    }
